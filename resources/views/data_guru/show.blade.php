            ...
            <div class="bg-white shadow-xl sm:rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h4 class="text-lg font-semibold text-blue-600 mb-4">Personal Information</h4>
                            <div class="space-y-3">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h4 class="text-lg font-semibold text-blue-600 mb-4">Additional Information</h4>
                            <div class="space-y-3">
                                <div class="flex items-center">
                                    <span class="text-gray-600 w-32">Sex</span>
                                    <span class="font-medium">{{ $user->sex }}</span>
                                </div>
                                <div class="flex items-center">
                                    <span class="text-gray-600 w-32">Marital Status</span>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg md:col-span-2">
                            <h4 class="text-lg font-semibold text-blue-600 mb-4">Address</h4>
                ...
                <div class="border-t bg-gray-50 px-6 py-3">
                    <div class="flex justify-between items-center">
                        <a href="{{ route('data_guru.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition duration-150 ease-in-out">
