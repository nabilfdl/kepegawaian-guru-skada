            ...
            <div class="bg-white shadow-xl sm:rounded-lg overflow-hidden">
                ...
                <div class="border-t bg-gray-50 px-6 py-3">
                    <div class="flex justify-between items-center">
                        <a href="{{ route('edit_data_diri.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition duration-150 ease-in-out">
