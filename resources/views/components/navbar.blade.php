<nav class="bg-gray-800" x-data="{ isOpen: false }">
            ...
            <div class="relative ml-3">
              <div>
                ...
                class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="size-8 rounded-full" src="Profil.jpg/img" alt="">
                </button>
              </div>
    ...
    <div x-show='isOpen'  class="md:hidden" id="mobile-menu"> 
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <a href="/Beranda" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-semibold text-white" aria-current="page">Beranda</a>
        <a href="/UlangTahun" class="block rounded-md px-3 py-2 text-base font-semibold text-gray-300 hover:bg-gray-700 hover:text-white">Ulang Tahun</a>
        <a href="/Ganti-Data" class="block rounded-md px-3 py-2 text-base font-semibold text-gray-300 hover:bg-gray-700 hover:text-white">Ganti Data</a>
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base/5 font-semibold text-white">Nabmiao</div>
            <div class="text-sm font-semibold text-gray-400">nabmiao@nyaonyao.com</div>
          </div>  
        </div>
